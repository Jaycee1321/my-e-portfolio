<template>
  ...
  <section id="tools" class="py-5">
    <div class="container text-center">
      <h2 class="mb-5">Tools & Skills I Use</h2>
      <div class="row g-5">
          ...
          <div class="tech-item-holder">
            <div class="tech-child" data-aos="fade-down">
              <div class="tech-child-child">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" alt="HTML" class="tech-icons">
              </div>
              <span>HTML</span>
            </div>
        ...
        <div class="col-md-4">
          ...
          <div class="tech-item-holder">
            <div class="tech-child" data-aos="fade-down">
              <div class="tech-child-child">
                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/git/git-original.svg" alt="Git" class="tech-icons">
              </div>
              <span>Git</span>
            </div>
